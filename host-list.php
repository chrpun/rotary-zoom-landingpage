...
host-list.php
>> Fragt Passwort für Anzeige der Anmeldungen ab.
...
if (!empty($_POST)) {
  ...
  if(!$error){
    ...
    readfile($save_filename);
    
    
    //echo file_get_contents($save_filename);
...
<head>
  ...
  <title><?php echo $club_name ?> // Anzeige der Anmeldungen</title>
          ...
          <div class="row">
            <div class="col-md-11 col-lg-10 mx-auto">
              <div class="text-center mb-4">
                ...
                <h3 class="login-heading mt-3">Anzeige der Anmeldedaten</h3>
              </div>
 
              <div class="mb-5 text-center">
                Bitte das Host-Passwort eintragen um die Anmeldedaten anzuzeigen.
              </div>
              ...
              <form method="post" novalidate>
                ...
                <button class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2" type="submit">Daten anzeigen</button>
            </form>
